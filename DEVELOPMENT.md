...
pub   ed25519 2024-10-06 [SC]
      4C946AB2F748CF0187284C260E93F7EBDAAE4407
...
```bash
gpg --keyserver keyserver.ubuntu.com --send-keys 4C946AB2F748CF0187284C260E93F7EBDAAE4407
```
...
```bash
gpg --armor --export-secret-keys 4C946AB2F748CF0187284C260E93F7EBDAAE4407 > key.gpg
```
