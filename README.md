...
```
    implementation("io.github.agraman4u.appconfig:app-config-parser:1.0")
```

2. Create a `configuration/app-config` directory in your project resources folder.
```
...
5. Add config to map the `configuration` dir to resources folders
```dsl
kotlin {
    sourceSets {
...
```
    import io.github.agraman4u.appconfig.AppConfig
